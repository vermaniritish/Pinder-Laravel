...
class Sliders extends AppModel
{
    ...
    */
    ...
    {
    	$listing = Sliders::orderByRaw($orderBy);
    ...
    * @param $orderBy
    */
    public static function getRow($where = [], $orderBy = 'sliders.id desc')
    {
    	$record = Sliders::orderByRaw($orderBy);
    ...
    */
    public static function modifyAll($ids, $data)
    {
    	if(!empty($ids))
    	{
    		return Sliders::whereIn('sliders.id', $ids)
		    		->update($data);
	    }
	    else
	    {
