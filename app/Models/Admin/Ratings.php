...
class Ratings extends AppModel
{
    ...
    */
    ...
    {
    	$orderBy = $request->get('sort') ? $request->get('sort') : 'ratings.id';
    	$direction = $request->get('direction') ? $request->get('direction') : 'desc';
    	$page = $request->get('page') ? $request->get('page') : 1;
    	$limit = self::$paginationLimit;
    	$offset = ($page - 1) * $limit;
    	
        $listing = Ratings::select([
            'ratings.*',
            'owner.first_name as owner_first_name',
            'owner.last_name as owner_last_name'
        ])
        ->leftJoin('admins as owner', 'owner.id', '=', 'ratings.created_by')
    ...
    * @param $limit
    */
    public static function getAll($select = [], $where = [], $orderBy = 'ratings.id desc', $limit = null)
    {
    	$listing = Ratings::orderByRaw($orderBy);
    ...
    * @param $orderBy
    */
    public static function getRow($where = [], $orderBy = 'ratings.id desc')
    {
    	$record = Ratings::orderByRaw($orderBy);
    ...
    */
    public static function modifyAll($ids, $data)
    {
    	if(!empty($ids))
    	{
    		return Ratings::whereIn('ratings.id', $ids)
		    		->update($data);
	    }
	    else
	    {
