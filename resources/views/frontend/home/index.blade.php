                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col">
                                            <div class="slider__content">
                                                ...
                                                <a class="slider__btn primary__btn" href="/">Shop Now
                                    ...
                                    <div class="col">
                                        <div class="hero__slider--items__inner">
                                            <div class="slider__content">
                                                ...
                                                <p class="slider__content--desc desc2 d-sm-2-none mb-40 ">Up To 40% Off Final Sale Items. <br>
                                                    Caught in the Moment!</p>    
                                                <a class="primary__btn slider__btn" href="/">Shop Now
                            ...
                            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">T-Shirts</span>
                                            <h3 class="product__items--content__title h4"><a href="product-details.php">Pro Polo</a></h3>
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket</span>
                                            <h3 class="product__items--content__title h4"><a href="product-details.php">2 Layer Softshell Jacket</a></h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jumper</span>
                                            <h4 class="product__items--content__title"><a href="product-details.php">Fleece Jumper with Reflective Tape</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Trousers</span>
                                            <h4 class="product__items--content__title"><a href="product-details.php">Taped Utility Trousers</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Footwear</span>
                                            <h4 class="product__items--content__title"><a href="product-details.php">Slip-On Safety Boots</a></h4>
                                            <div class="product__items--price">
                    ...
                    <div class="row row-cols-1 align-items-center">
                        <div class="col">
                            <div class="deals__banner--content position__relative">
                                ...
                                <a class="primary__btn" href="/">Shop Now
                                    <svg class="primary__btn--arrow__icon" xmlns="http://www.w3.org/2000/svg" width="20.2" height="12.2" viewBox="0 0 6.2 6.2">
                                    <path d="M7.1,4l-.546.546L8.716,6.713H4v.775H8.716L6.554,9.654,7.1,10.2,9.233,8.067,10.2,7.1Z" transform="translate(-4 -4)" fill="currentColor"></path>
                                    </svg>
                                </a>
