						...
						<div class="col">
							<div class="account__login">
								<div class="account__login--header mb-25">
									<h2 class="account__login--header__title h3 mb-10">Second Factor Authentication?</h2>
									<p class="account__login--header__desc">Enter one time password to reset your password.</p>
								</div>
								<div class="account__login--inner">
									<form id="otp-form">
										<input class="account__login--input" required name="otp" placeholder="OTP" type="number">
