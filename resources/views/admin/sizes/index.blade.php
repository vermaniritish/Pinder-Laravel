		...
		<div class="container-fluid">
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<?php if(Permissions::hasPermission('sizes', 'create')): ?>
						<a href="<?php echo route('admin.size.add') ?>" class="btn btn-neutral">
						<i class="fas fa-plus"></i> New</a>
					<?php endif; ?>	
						@include('admin.size.filters')
					</div>
				</div>
			</div>
		</div>
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
										<?php if(Permissions::hasPermission('sizes', 'update')): ?>
											<a 
												class="dropdown-item" 
												href="javascript:;"
												onclick="bulk_actions('<?php echo route('admin.size.bulkActions', ['action' => 'active']) ?>', 'active');"
											>
											...
											<a 
												class="dropdown-item" 
												href="javascript:;"
												onclick="bulk_actions('<?php echo route('admin.size.bulkActions', ['action' => 'inactive']) ?>', 'inactive');"
											>
												<span class="badge badge-dot mr-4">
										...
										<?php if(Permissions::hasPermission('sizes', 'delete')): ?>
											<a 
												...
												onclick="bulk_actions('<?php echo route('admin.size.bulkActions', ['action' => 'delete']) ?>', 'delete');">
						...
						<table class="table align-items-center table-flush listing-table">
							...
							<tbody class="list">
								<?php if(!empty($listing->items())): ?>
									@include('admin.size.listingLoop')
								<?php else: ?>
