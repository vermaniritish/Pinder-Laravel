			...
			<div class="card">
				...
				<div class="card-header">
					<div class="row align-items-center">
						<div class="col-8">
							<h3 class="mb-0">Create New Sugession Here.</h3>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.searchSugessions.add') ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
						<h6 class="heading-small text-muted mb-4">Sugession information</h6>
						<div class="pl-lg-4">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<div class="custom-control">
											...
											<label class="custom-control-label">Do you want to publish this sugession?</label>
										</div>
									</div>
								</div>
							</div>
