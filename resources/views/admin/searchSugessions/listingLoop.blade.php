...
<tr>
	<td>
		...
		<div class="custom-control custom-checkbox">
			<?php if(strpos($row->slug, 'all-products') > -1): ?>
			<input type="checkbox" class="custom-control-input listing_check" disabled="">
			<?php else: ?>
	...
	<td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'search_sugessions', 'field' => 'status', 'id' => $row->id]); ?>
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
				<?php if(Permissions::hasPermission('search_sugessions', 'update')): ?>
					<a class="dropdown-item" href="<?php echo route('admin.searchSugessions.edit', ['id' => $row->id]) ?>">
						<i class="fas fa-pencil-alt text-info"></i>
						<span class="status">Edit</span>
					</a>
				<?php endif; ?>
				<?php
				if(strpos($row->slug, 'all-products') === false && Permissions::hasPermission('search_sugessions', 'delete')): ?>
					<div class="dropdown-divider"></div>
					<a 
						class="dropdown-item _delete" 
						href="javascript:;"
						data-link="<?php echo route('admin.searchSugessions.delete', ['id' => $row->id]) ?>"
					>
