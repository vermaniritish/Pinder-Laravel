	...
	<div class="row">
		<div class="col-xl-12 order-xl-1">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.users.add') ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
							...
							<div class="form-group">
								<div class="custom-control">
									<label class="custom-toggle">
										...
										<input type="checkbox" name="seller" value="1" id="seller" <?php echo (old('seller') != '0' ? 'checked' : '') ?>>
										<span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
									</label>
									<label class="custom-control-label">Seller registration?</label>
								</div>
