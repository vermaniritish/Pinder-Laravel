...
<!--!!!!! DO NOT REMOVE listing-block CLASS. INCLUDE THIS IN PARENT DIV OF TABLE ON LISTING PAGES !!!!!-->
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						<div class="heading">
							<h3 class="mb-0">Here Is Your Customers Listing!</h3>
						</div>
						<div class="actions">
						...
						<table class="table align-items-center table-flush listing-table">
							<thead class="thead-light">
								<tr>
									...
									<th class="sort">
										Role
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'users.seller' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="users.name" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'users.seller' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="users.seller" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="users.seller"></i>
										<?php endif; ?>
									</th>
									<th class="sort">
										Email
