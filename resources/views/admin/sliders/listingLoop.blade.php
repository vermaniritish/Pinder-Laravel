...
<tr>
	...
	<td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'sliders', 'field' => 'button_status', 'id' => $row->id]); ?>
				<input type="checkbox" name="button_status" onchange="switch_action('<?php echo $switchUrl ?>', this)" value="1" <?php echo ($row->button_status ? 'checked' : '') ?>>
	...
	<td>
    	<?php echo Str::limit($row->sub_heading, 100, '...'); ?>
	</td>
	<td>
		<?php echo $row->button_title ?>
	</td>
	<td class="text-cnter">
	<?php if(Permissions::hasPermission('sliders', 'update') || Permissions::hasPermission('sliders', 'delete')): ?>
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
				<a class="dropdown-item" href="<?php echo route('admin.sliders.view', ['id' => $row->id]) ?>">
					<i class="fas fa-eye text-yellow"></i>
					<span class="status">View</span>
				</a>
				<?php if(Permissions::hasPermission('sliders', 'update')): ?>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo route('admin.sliders.edit', ['id' => $row->id]) ?>">
				...
				<?php if(Permissions::hasPermission('sliders', 'delete')): ?>
					...
					<a 
						...
						href="javascript:;"
						data-link="<?php echo route('admin.sliders.delete', ['id' => $row->id]) ?>"
					>
