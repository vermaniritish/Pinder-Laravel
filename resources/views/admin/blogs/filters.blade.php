<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="<?php echo route('admin.blogs') ?>" id="filters-form">
					      		...
					      		<?php if($c->sub_categories()->count() > 0): ?>
					      			<optgroup label="<?php echo $c->title ?>">
					      				...
					      				<?php foreach($c->sub_categories as $c): ?>
					      					<option value="<?php echo $c->id ?>" <?php echo isset($_GET['category']) && in_array($c->id, $_GET['category'])  ? 'selected' : '' ?>><?php echo $c->title ?></option>
					      				<?php endforeach; ?>
			...
			<div class="dropdown-divider"></div>
			<a href="<?php echo route('admin.blogs') ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
