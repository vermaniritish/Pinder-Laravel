...
<!--!!!!! DO NOT REMOVE listing-block CLASS. INCLUDE THIS IN PARENT DIV OF TABLE ON LISTING PAGES !!!!!-->
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						<div class="heading">
							<h3 class="mb-0">Here Is Your Blogs Listing!</h3>
						</div>
						<div class="actions">
							...
							<thead class="thead-light">
								<tr>
									...
									<th class="sort">
										...
										Id
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'blogs.id' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="blogs.id" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'blogs.id' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="blogs.id" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="blogs.id" data-sort="asc"></i>
										<?php endif; ?>
									</th>
									<th class="sort">
										Title
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'blogs.title' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="blogs.title" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'blogs.title' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="blogs.title" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="blogs.title"></i>
										<?php endif; ?>
									</th>
									<th class="sort">
										Created By
									...
									<th class="sort">
										Status
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'blogs.status' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="blogs.status" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'blogs.status' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="blogs.status" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="blogs.status"></i>
										<?php endif; ?>
									</th>
									<th class="sort">
										Created ON
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'blogs.created' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="blogs.created" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'blogs.created' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="blogs.created" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="blogs.created"></i>
										<?php endif; ?>
									</th>
									<th>
										Actions
