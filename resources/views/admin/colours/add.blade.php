						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="title" required placeholder="Colour Title" value="{{ old('title') }}">
									@error('title')
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="code" required placeholder="Colour Code" value="{{ old('code') }}">
									@error('code')
										<small class="text-danger">{{ $message }}</small>
									@enderror
								</div>
