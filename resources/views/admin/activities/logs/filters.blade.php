<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="<?php echo route('admin.activities.logs') ?>" id="filters-form">
					...
					<div class="col-md-12">
						...
						<select class="form-control" name="users[]" multiple>
					      	<?php foreach($users as $c): ?>
					      		<option value="<?php echo $c->id ?>" <?php echo isset($_GET['users']) && in_array($c->id, $_GET['users'])  ? 'selected' : '' ?>><?php echo $c->first_name . ' ' . $c->last_name ?></option>
					  		<?php endforeach; ?>
					    </select>
					</div>
				</div>
			...
			<div class="dropdown-divider"></div>
			<a href="<?php echo route('admin.activities.logs') ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
