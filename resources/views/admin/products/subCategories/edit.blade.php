	...
	<div class="row">
		<div class="col-xl-12 order-xl-1">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.products.subCategories.edit', ['id' => $category->id]) ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
								...
								<div class="col-md-12">
									...
									>
										...
										<div class="fixed-edit-section">
											@include('admin.partials.previewFileRender', ['file' => $category->image, 'relationType' => 'product_categories.image', 'relationId' => $category->id ])
										</div>
									</div>
								</div>
							</div>
