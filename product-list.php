...
<?php require_once 'header-bottom.php'; ?>
   <div class="offcanvas__filter--sidebar widget__area">
        ...
        <div class="offcanvas__filter--sidebar__inner">
			...
			<?php require_once 'sidebar-productlist-mobile.php'; ?>
                    ...
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
								...
								<li class="breadcrumb__content--menu__items mb-25 mt-15"><a href="index.php">T-Shirts</a></li>
                                <li class="breadcrumb__content--menu__items mb-25 mt-15"><span>V Neck</span></li>
                            </ul>
							<h2 class="breadcrumb__content--title mb-15">V Neck</h2>
							<p class="mt-15">Dive into our exceptional range of t-shirts, able to cater to any occasion, event or workplace. Our personalised t-shirts allow for you to inject a sense of personality among your team, with customisation, embroidery and the option to add your company logo to each piece for your team. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4">
							...
							<?php require_once 'sidebar-productlist.php'; ?>
